        ...
        <div className="flex items-end gap-8">
          <div className="relative group">
            <button
              ...
              className="w-40 h-40 rounded-full border-4 border-white shadow-lg overflow-hidden bg-gray-100 flex items-center justify-center hover:opacity-80 transition-opacity relative"
              disabled={uploading}
            >
              {user.avatar_url ? (
